...
%>
	<hr>
	学生信息导入：
	<wx:fileupload savepath ="relative{/upload}" uploadcount="1" newfilename="<%=newfilename%>" allowtypes ="xls;xlsx" interceptor="cn.edu.hrbeu.interceptor.StudentImport">
	  <input type="button" value="从Excel导入"/>
	 </wx:fileupload>
	  <a href="download/student_import.xls">模板下载</a> <br>
